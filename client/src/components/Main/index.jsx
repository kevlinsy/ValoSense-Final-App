...
<nav className="navbar navbar-expand-lg navbar-Dark bg-DARK  " >
  <div className="container-fluid">
    <a className="navbar-brand" href="Index.html"><img src="images/full_logo.png" style="height:80;width:150"></img></a>
...
<body>
  <div id="myCarousel" className={`slide ${styles["carousel"]}`}
 data-ride="carousel">
  ...
  <div className="container marketing">
    ...
    <div className="row">
      <div className="col-lg-4">
        <img className="rounded-circle" src="images/medal.png" alt="Generic placeholder image" width="140" height="140">
        <h2>WINNERS OF THE COMPETITION</h2>
        <p>This 2022, 3 winners joined us in competing against the top....</p>
        <p><a className="btn btn-secondary" href="#" role="button">View details »</a></p>
      </div>
      <div className="col-lg-4">
        <img className="rounded-circle" src="images/data-server.png" alt="Generic placeholder image" width="140" height="140">
      ...
      <div className="col-lg-4">
        <img className="rounded-circle" src="images/competitive.png" alt="Generic placeholder image" width="140" height="140">
    ...
    <div className="row featurette">
      ...
      <div className="col-md-5">
        <img className="featurette-image img-fluid mx-auto" data-src="holder.js/500x500/auto" alt="500x500" style="width: 500px; height: 500px;" src="images/picture.jpg_large" data-holder-rendered="true">
      </div>
    </div>
    ...
    <div className="row featurette">
      ...
      <div className="col-md-5 order-md-1">
        <img className="featurette-image img-fluid mx-auto" data-src="holder.js/500x500/auto" alt="500x500" src="images/picture1.jpeg" data-holder-rendered="true" style="width: 500px; height: 500px;">
      </div>
    </div>
    ...
    <div className="row featurette">
      ...
      <div className="col-md-5">
        <img className="featurette-image img-fluid mx-auto" data-src="holder.js/500x500/auto" alt="500x500" src="images/picture2.jpeg" data-holder-rendered="true" style="width: 500px; height: 500px;">
      </div>
    </div>
...
<Ul> <p className=" text-white nav col-md-0 justify-content footerLogos">&copy; 2022 Valosense, Inc</p></ul>

 <a className="nav col-md-0 justify-content-center footerLogos" style=" align-items: center; justify-content: center;  ">
